...
이는 변경이 없는 쿼리문 자체나 테이블 이름과 같은 메타 정보를 담은 [QueryInfo 타입](https://github.com/mysql/mysql-connector-j/blob/fdef61f4af21fa9e0ac334ff0664ec754c164cc0/src/main/core-api/java/com/mysql/cj/QueryInfo.java#L42)을 캐싱해서 파라미터를 별도로 처리하기 위함입니다.  
